...
JimSMake 是一款专业的潜意识音频制作工具，提供直观的图形界面，帮助用户轻松创建潜意识音频内容。无论是用于自我提升、冥想、学习辅助还是娱乐创作，JimSMake 都能满足您的需求。

###  主要特性

- **肯定语处理** - 支持音频文件导入、文本转语音、录制等多种输入方式
- **音频效果** - 音量调节、频率变换（亚超声波/次声波）、倍速控制、倒放功能
...
1. 生成翻译文件：
   ...
   ```bash
   pylupdate5 JimSMake.py -ts translations/JimSMake_zh_CN.ts
   ```
...
3. 编译生成 .qm 文件：
   ...
   ```bash
   lrelease translations/JimSMake_zh_CN.ts
   ```
...
- 提交 [Issue](https://github.com/Jimmy32767255/JimSMake/issues)
